              ...
              <ScrollAnimatedSection id="why-eaw-section" className="max-w-5xl mx-auto px-6 scroll-mt-36 sm:scroll-mt-48 md:scroll-mt-56 lg:scroll-mt-64">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start pb-12 border-b border-zinc-900">
                  ...
                  <div className="lg:col-span-7 divide-y divide-zinc-900">
                    ...
                    <div className="py-6 group flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-all duration-300 hover:bg-zinc-950/10 rounded-lg px-2">
                      <div className="flex items-center gap-4 shrink-0 sm:w-44">
                        <span className="text-xl font-serif text-[#B08D57]/30 group-hover:text-[#B08D57] transition-all font-bold">// 01</span>
                        <h4 className="font-bold text-white text-sm font-serif group-hover:translate-x-1 transition-transform">No Mock Templates</h4>
                      </div>
                      <p className="text-zinc-455 text-xs font-sans leading-relaxed max-w-sm sm:pl-4 sm:border-l sm:border-zinc-900/80 group-hover:border-[#B08D57]/30 transition-colors">
                    ...
                    <div className="py-6 group flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-all duration-300 hover:bg-zinc-950/10 rounded-lg px-2">
                      <div className="flex items-center gap-4 shrink-0 sm:w-44">
                        <span className="text-xl font-serif text-[#B08D57]/30 group-hover:text-[#B08D57] transition-all font-bold">// 02</span>
                    ...
                    <div className="py-6 group flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-all duration-300 hover:bg-zinc-950/10 rounded-lg px-2">
                      <div className="flex items-center gap-4 shrink-0 sm:w-44">
                        <span className="text-xl font-serif text-[#B08D57]/30 group-hover:text-[#B08D57] transition-all font-bold">// 03</span>
                    ...
                    <div className="py-6 group flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-all duration-300 hover:bg-zinc-950/10 rounded-lg px-2">
                      <div className="flex items-center gap-4 shrink-0 sm:w-44">
                        <span className="text-xl font-serif text-[#B08D57]/30 group-hover:text-[#B08D57] transition-all font-bold">// 04</span>
              ...
              <ScrollAnimatedSection id="leadership-section" className="max-w-6xl mx-auto px-6 scroll-mt-36 sm:scroll-mt-48 md:scroll-mt-56 lg:scroll-mt-64">
                ...
                <div className="mb-16">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <div className="bg-[#0b1c33]/30 backdrop-blur-md border border-zinc-800/60 p-5 rounded-lg flex flex-col justify-between hover:border-[#B08D57]/30 transition-all duration-300 group">
                      <div>
