      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full flex-grow flex flex-col justify-center md:justify-start pt-24 pb-16 md:pt-16 lg:pt-20 md:pb-0">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex flex-col min-[480px]:flex-row items-stretch min-[480px]:items-center gap-[12px] pt-1 w-full max-w-[28rem] min-[480px]:max-w-none shadow-none" id="hero-cta-container">
              {activeSlide.ctas ? (
                activeSlide.ctas.map((cta, idx) => (
                  <button
                    ...
                    className={`w-full min-[480px]:w-auto px-4 py-2.5 rounded text-[10px] font-bold uppercase tracking-widest font-mono transition-all ${
                      idx === 0 
                        ? "bg-[#B08D57] text-white hover:bg-[#8C6A35]" 
                        : "bg-zinc-950/40 text-zinc-300 border border-white/10 hover:bg-zinc-900/60"
                    }`}
                  >
                    {cta}
                  </button>
                ...
                <button
                  ...
                  id="hero-cta-single-btn"
                  className="w-full min-[480px]:w-auto px-5 py-3 rounded text-[10px] font-bold uppercase tracking-widest font-mono bg-[#B08D57] text-white hover:bg-[#8C6A35]"
                >
                  {activeSlide.ctaText}
                </button>
              ) : null}
